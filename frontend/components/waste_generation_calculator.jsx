        ...
        <CardBody>
          <Flex alignItems="flex-start">
            ...
            <Box>
              ...
              <UnorderedList fontSize="14px" fontWeight="500" lineHeight="28px">
                <ListItem>Total waste generated monthly.</ListItem>
                <ListItem>
                  This is the total monthly waste generated by your business.
                  Aim to reduce these numbers by adopting eco-friendly packaging
                  solutions.
                </ListItem>
              </UnorderedList>
            </Box>
          ...
          <Flex alignItems="flex-start">
            ...
            <Box>
              ...
              <UnorderedList fontSize="14px" fontWeight="500" lineHeight="28px">
                <ListItem>Total waste generated yearly</ListItem>
                <ListItem>
